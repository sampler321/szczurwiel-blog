...
export async function getAllPostsForHome() {
  try {
    ...
    console.log('Ghost API call successful for getAllPostsForHome, posts count:', posts.length)
    ...
    console.error('Error in getAllPostsForHome:', error)
    throw error
  }
}
...
export async function getPostAndMorePosts(slug) {
  try {
    ...
    console.log('Ghost API call successful for getPostAndMorePosts, slug:', slug)
    ...
    console.error('Error in getPostAndMorePosts:', error)
    throw error
  }
}
...
export async function getAuthorDetails(slug) {
  try {
    const author = await api.authors.read({ slug }, { fields: 'id,name,slug,profile_image,url' })
    return author
  } catch (e) {
    return null
  }
